  ...
  <body>
	...
	<div class="container-fluid mybody">
	      ...
	      <div class="container-fluid well mycontext" id="container-Info">
	        ...
	        <form action="${pageContext.request.contextPath }/staff/findStaffBaseInfoInSaOf.html" method="post">
	      	<!-- 页标 -->
	          ...
	          <div class="form-group form-inline text-center col-md-offset-1 col-md-10">
	            ...
	            <div class="form-group col-md-4">
	                ...
	                <select class="form-control" style="width:196px;" name="staff.dataDictionaryByStatus.id" sele="${staff.dataDictionaryByStatus.id }">
		          ...
		          <script type="text/javascript">
		          		...
		          		dataDictionary("STAFF_STATUS",function(data){
		          			var target = $("[name='staff.dataDictionaryByStatus.id']");
	        				for(var dd in data){
	        					var val = data[dd];
	        ...
	        <div class="container-fluid" style="margin-top:20px;border-left:1px dashed #008080;border-right:1px dashed #008080;border-radius:20px;padding:30px 40px 0px;max-width:95%;">
	          <table class="ui blue selectable celled table">
	            ...
	            <tbody>
		            ...
		            <c:forEach items="${staffList }" var="tsta">
		            	<tr>
			                <td>${tsta.no }</td>
			                <td>${tsta.name }</td>
			                <td >${tsta.sex }</td>
			                <td><fmt:formatNumber type="number" maxFractionDigits="0" value="${(nowDate.time - tsta.bornDate.time)/(365*24*60*60*1000) }" /></td>
			                <td>${tsta.position.name }</td>
			                <td>${tsta.dataDictionaryByStatus.value }</td>
